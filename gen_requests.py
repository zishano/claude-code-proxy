#!/usr/bin/env python3
"""
Claude Code Proxy — 生成多条 Request History 脚本
持续向代理(3001)发送模拟的 Claude Code 请求,生成多样化数据,
便于在 5173 面板上观察对话流、工具调用链等多条 Request History。

用法:
    python3 gen_requests.py [请求数] [间隔秒]
    例: python3 gen_requests.py 50 1     # 发50条,间隔1秒
    例: python3 gen_requests.py 0 0.5    # 无限发,间隔0.5秒(Ctrl+C 停)
默认: 30条, 间隔0.8秒
"""
